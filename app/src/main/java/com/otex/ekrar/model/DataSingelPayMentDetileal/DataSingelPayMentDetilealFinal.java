...
public class DataSingelPayMentDetilealFinal {
    ...
    public DataSingelPayMentDetilealFinal(Integer id, Integer financialDocumentId, String payment, String date, Integer documentType, Integer status, String createdAt, String updatedAt,
                                          Integer paid, Integer rest, List<PaidPayment> paidPayments) {
        this.id = id;
        this.financialDocumentId = financialDocumentId;
        this.payment = payment;
        this.date = date;
