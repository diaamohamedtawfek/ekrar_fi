...
import com.otex.ekrar.model.dataAllSendDucument.Currency;
...
import com.otex.ekrar.startApp.ConfirmUserActivity;
...
public class SentDocument extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
...
//    int currentItems, totalItems, scrollOutItems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sent_document);
       ...
       imageButton=findViewById(R.id.image_arrow);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                BottomsheetDialogCashDoc bottomsheetDialog = new BottomsheetDialogCashDoc(2);
    ...
    private void startUI() {
        ...
        recyclerView_dAdapter = new Send_decument_Recycal_ViewHolder(listItems,SentDocument.this, getApplicationContext(),"send");
...
//        });
    ...
    private void getjson(final int docType,int states) {
        ...
        final RequestQueue requestQueue = Volley.newRequestQueue(SentDocument.this);
        Gson gson1 = new Gson();
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Urls.sent_document
                , jsonObject, response -> {
...
//                }
   ...
   void showData(){
    ...
    public void applySearch(String name, String from, String to, String paytype,String code){
        ...
        gridLayoutManager = new GridLayoutManager(getApplicationContext(), 1);
        recycal_deliverys.setLayoutManager(gridLayoutManager);
        recyclerView_dAdapter = new Send_decument_Recycal_ViewHolder(listItems,SentDocument.this, getApplicationContext(),"res");
        recycal_deliverys.setAdapter(recyclerView_dAdapter);
