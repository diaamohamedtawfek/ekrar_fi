...
public class ConfirmationActivity extends AppCompatActivity {
    ...
    private void actionButton() {
        ...
        sendConfirmButton.setOnClickListener(v -> {
            ...
            if (conMgr.getActiveNetworkInfo() != null && conMgr.getActiveNetworkInfo().isAvailable() && conMgr.getActiveNetworkInfo().isConnected()) {
                ...
                Toast.makeText(ConfirmationActivity.this, "Check Your Network", Toast.LENGTH_SHORT).show();
            }
    ...
    private void addReqestData(){
        ...
        final RequestQueue requestQueue = Volley.newRequestQueue(ConfirmationActivity.this);
        Gson gson = new Gson();

        DataSendConfirmCodeForgetPassword contactsTop=new DataSendConfirmCodeForgetPassword();
        contactsTop.setReset_code(codeConfirm.getText().toString().trim());
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Urls.accountVerifyForgetPassword
                , jsonObject, response -> {
            ...
            if (!dataDelevery.getSuccess().equals(true)){
                ...
                Toast.makeText(ConfirmationActivity.this, "تم التسجيل بنجاح", Toast.LENGTH_LONG).show();
    ...
    private void resendCOde(){
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, Urls.resendCode
            ...
            if (!dataDelevery.getSuccess().equals(true)){
                ...
                Toast.makeText(ConfirmationActivity.this, "تم الارسال", Toast.LENGTH_LONG).show();

                SharedPrefManager sharedPrefManager = new SharedPrefManager(ConfirmationActivity.this);
